...
import com.codingshuttle.projects.CodeNova_AI.service.PaymentProcessor;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    @Override
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) throws IOException {
        ...
        switch (type) {
            ...
            case "customer.subsciption.deleted" ->
                    handleCustomerSubscriptionDeleted((Subscription) stripeObject); //when subsciption ends, revoke the access
    ...
    private void handleCheckoutSessionCompleted(Session session, Map<String, String> metadata) throws IOException {
        ...
        Long userId = Long.parseLong(metadata.get("user_id")); // userId : 1
        Long planId = Long.parseLong(metadata.get("plan_id"));  // planId : 1 metadata : size = 2

        String subsciptionId = session.getSubscription();
        ...
        subscriptionService.activateSubscription(userId, planId, subsciptionId, customerId);
    }
